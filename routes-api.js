...
module.exports = [
  ...
  { method: "POST", path: "/api/castle/edit", config: Castles.edit },
  ...
  { method: "GET", path: "/api/users/checkemail/{email}", config: Users.checkEmail },
  { method: "GET", path: "/api/users/token", config: Users.getUserFromToken },
